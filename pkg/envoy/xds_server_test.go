...
var L4PolicyMap1 = policy.InitL4PolicyMap(map[string]*policy.L4Filter{
	"80/TCP": {
		Port:     80,
...
var L4PolicyMap1HeaderMatch = policy.InitL4PolicyMap(map[string]*policy.L4Filter{
	"80/TCP": {
		Port:     80,
		Protocol: api.ProtoTCP,
		L7Parser: policy.ParserTypeHTTP,
...
var L4PolicyMap1RequiresV2 = policy.InitL4PolicyMap(map[string]*policy.L4Filter{
	"80/TCP": {
		Port:     80,
		Protocol: api.ProtoTCP,
		L7Parser: policy.ParserTypeHTTP,
...
var L4PolicyMap2 = policy.InitL4PolicyMap(map[string]*policy.L4Filter{
	"8080/TCP": {
		Port:     8080,
		Protocol: api.ProtoTCP,
		L7Parser: policy.ParserTypeHTTP,
...
var L4PolicyMap3 = policy.InitL4PolicyMap(map[string]*policy.L4Filter{
	"80/TCP": {
		Port:     80,
		Protocol: api.ProtoTCP,
		L7Parser: policy.ParserTypeHTTP,
...
var L4PolicyMap4 = policy.InitL4PolicyMap(map[string]*policy.L4Filter{
	"80/TCP": {
		Port:     80,
		Protocol: api.ProtoTCP,
		PerSelectorPolicies: policy.L7DataMap{
...
var L4PolicyMap5 = policy.InitL4PolicyMap(map[string]*policy.L4Filter{
	"80/TCP": {
		Port:     80,
		Protocol: api.ProtoTCP,
		PerSelectorPolicies: policy.L7DataMap{
...
var L4PolicyMapSNI = policy.InitL4PolicyMap(map[string]*policy.L4Filter{
	"443/TCP": {
		Port:     443,
		Protocol: api.ProtoTCP,
		PerSelectorPolicies: policy.L7DataMap{
...
var L4PolicyL7 = &policy.L4Policy{
	Ingress: policy.L4DirectionPolicy{PortRules: policy.InitL4PolicyMap(map[string]*policy.L4Filter{
		"9090/TCP": {
...
var L4PolicyMySQL = &policy.L4Policy{
	Egress: policy.L4DirectionPolicy{PortRules: policy.InitL4PolicyMap(map[string]*policy.L4Filter{
		"3306/TCP": {
