...
func TestMergeAllowAllL3AndShadowedL7(t *testing.T) {
	...
	expected := InitL4PolicyMap(map[string]*L4Filter{"80/TCP": {
		Port:     80,
...
func TestMergeIdenticalAllowAllL3AndRestrictedL7Kafka(t *testing.T) {
	...
	expected := InitL4PolicyMap(map[string]*L4Filter{"9092/TCP": {
		Port:     9092,
		Protocol: api.ProtoTCP,
		U8Proto:  6,
		wildcard: td.wildcardCachedSelector,
...
func TestMergeTLSTCPPolicy(t *testing.T) {
	...
	expected := InitL4PolicyMap(map[string]*L4Filter{"443/TCP": {
		Port:     443,
		Protocol: api.ProtoTCP,
		U8Proto:  6,
		wildcard: nil,
...
func TestEntitiesL3(t *testing.T) {
	...
	expected := InitL4PolicyMap(map[string]*L4Filter{"0/ANY": {
		Port:     0,
