...
// InitL4PolicyMap creates an new L4PolicMap, with an initial
// set of values. The initMap argument does not support ranges.
func InitL4PolicyMap(initMap map[string]*L4Filter) L4PolicyMap {
	l4M := &l4PolicyMap{
		namedPortMap: make(map[string]*L4Filter),
		rangePortMap: bitlpm.NewUintTrie[uint32, map[portProtoKey]*L4Filter](),
	}
...
// LongetstPrefixMatch looks up an L4Filter by protocol/port that contains the port and protocol
